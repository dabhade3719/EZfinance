...
if(isset($_POST['login'])) {
    ...
    if ($row) {
        $_SESSION['user_id'] = $row['id'];         // This stores the user ID in session
        $_SESSION['username'] = $row['uname'];     // This stores the username (optional)
        
        if ($uname === 'admin') {
            echo "<script>window.location.href = 'admin.php';</script>";
        } else {
            echo "<script>window.location.href = 'ai-chatbot.html';</script>";  // Redirect to tracker after login
        }
        exit;
